...
export default function CatalogCard({ catalog }: CatalogCardProps) {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[hsl(var(--muted-foreground))] hover:shadow-lg hover:shadow-black/20"
    >
