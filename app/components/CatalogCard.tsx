...
export default function CatalogCard({ catalog }: CatalogCardProps) {
  ...
  return (
    <Link
      ...
      className="group block overflow-hidden rounded-xl border border-[var(--border)] bg-[var(--card)] transition-colors hover:border-[var(--muted-foreground)]"
    >
      <div className="grid aspect-square grid-cols-2 gap-0.5 bg-[var(--border)]">
        {previewImages.length > 0 ? (
          ...
          <div className="col-span-2 flex items-center justify-center bg-[var(--card)]">
        ...
        {previewImages.length === 1 && (
          <>
            <div className="flex items-center justify-center bg-[var(--card)]">
